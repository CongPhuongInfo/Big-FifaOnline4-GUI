...
if "!CSC!"=="" (
    echo [ERROR] Khong tim thay csc.exe .NET Framework 4.x
    exit /b 1
)
...
"!CSC!" ^
  ...
  /out:"%cd%\FlatChunkZipExplorer.exe" ^
  "%cd%\FlatChunkZipExplorer.cs"

if %errorlevel%==0 (
    echo [OK] Build thanh cong: FlatChunkZipExplorer.exe
) else (
